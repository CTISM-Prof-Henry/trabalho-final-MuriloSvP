...
- **Tema:Site de uma hamburgueria.**
- **Público-alvo:Pessoas interessadas em conhecer o cardápio da hamburgueria.**
- **Funcionalidades:
Exibição dos hambúrgueres em cards.
Exibição dos ingredientes e preços.
